/* =======================================================================
 * Balhea ERP - Finance Schema (DDL) v7.9.1
 * -----------------------------------------------------------------------
 * 목적
 * - 비용(costs) 원장, 비용 귀속(cost_allocations), 실제 지급(payments) 및 증빙
 * - 환율은 비용 기준으로 "적용 환율"과 원화 환산 결과를 고정 저장(재현/감사 목적)
 * - 링크(*_links)는 조회/편의, 안분(*_allocations)은 원가/회계 계산의 기준
 * ======================================================================= */
